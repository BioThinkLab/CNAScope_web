...
export const getFocalCNAInfoUrl = (datasetName, workflow, binSize) => {
    return `${DATABASE_API_BASE}/focal_CNA_info/?dataset_name=${encodeURIComponent(datasetName)}&workflow_type=${encodeURIComponent(workflow)}&bin_size=${encodeURIComponent(binSize)}`
}
