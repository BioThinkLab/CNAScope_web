...
const ClusterSpatialMapPanel = forwardRef(({
    cluster,
    meta,
    extents,
    config
    ...
    useImperativeHandle(ref, () => ({
        downloadSvg: () => {
            ...
            downloadSvg(svgRef.current, `${embeddingMethod.slice(2)}_Spatial_Map.svg`)
        }
    }))
...
ClusterSpatialMapPanel.displayName = 'ClusterSpatialMapPanel'

export default ClusterSpatialMapPanel
